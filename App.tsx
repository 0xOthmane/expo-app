...
import calculator, { StateInterface } from './utils/calculator';
...
const App = () => {
  const [initialState, setState] = useState<StateInterface>({
    currentValue: '0',
    operator: '',
    previousValue: '',
  });
  ...
  const handleTap = (type: string, value?: number | string) => {
    const result = calculator(type, value!, initialState)
